//#EditorFriendly
//#node5:posx=-308:posy=-66:title=ParamColor:title2=ParamColor2:input0=(1,1,1,1):input0type=Color:
...
//#masterNode:posx=0:posy=0:title=Master Node:input0linkindexnode=5:input0linkindexoutput=0:
//#sm=3.0
//#blending=Normal
//#ShaderName
Shader "ShaderFusion/EloWater" {
	Properties {
_Color ("Diffuse Color", Color) = (1.0, 1.0, 1.0, 1.0)
_SpecColor ("Specular Color", Color) = (1.0, 1.0, 1.0, 1.0)
_Cutoff ("Alpha cutoff", Range(0,1)) = 0.5
//#ShaderProperties
_ParamColor2 ("ParamColor2", Color) = (1,1,1,1)
	}
	Category {
		SubShader { 
//#Blend
